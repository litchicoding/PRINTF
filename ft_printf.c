...
int	ft_eval_format(va_list arg, char specifier)
{
	...
	if (specifier == 'd' || specifier == 'i')
		count += ft_printf_digit(va_arg(arg, int), 10);
	// if (specifier == 'p')
	// 	count += ft_print_pointer(va_arg(arg, unsigned int));
	if (specifier == 'u')
		count += ft_printf_digit((unsigned int)va_arg(arg, unsigned int), 10);
	if (specifier == 'X')
		count += ft_printf_digit((unsigned int)va_arg(arg, unsigned int), 16);
	if (specifier == 'x')
		count += ft_printf_digit((unsigned int)va_arg(arg, unsigned int), 16);
	if (specifier == '%')
		count += write(1, "%", 1);
